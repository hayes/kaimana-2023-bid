...
export function Polaroid({
  ...
  return (
    <div
      ...
      } relative shadow-xl bg-white p-4 rounded-sm z-10 hover:rotate-0 hover:z-20 hover:scale-[1.3] transition-all hover:grayscale-0 grayscale-[20%] duration-500 ${rotate} scale-[80%]`}
    >
